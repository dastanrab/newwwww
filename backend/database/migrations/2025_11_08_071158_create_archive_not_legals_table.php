...
return new class extends Migration
{
    ...
    {
        Schema::create('archive_not_legals', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedBigInteger('city_id')->nullable()->default(1)->index('archive_not_legals_city_id_foreign');
            $table->unsignedBigInteger('receive_archive_id')->index('archive_not_legals_receive_archive_id_foreign');
            $table->dateTime('date');
            $table->integer('type');
    ...
    {
        Schema::dropIfExists('archive_not_legals');
    }
};
