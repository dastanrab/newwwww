...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('archive_apps', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('city_id')->nullable()->default(1)->index('archive_apps_city_id_foreign');
            $table->unsignedBigInteger('receive_archive_id')->index('archive_apps_receive_archive_id_foreign');
            $table->dateTime('date');
            $table->integer('type');
