...
//        $this->kavehnegarBalance = \Illuminate\Support\Facades\Cache::get('kave_balance');
//        try {
//            $this->kavehnegarBalance=\Illuminate\Support\Facades\Cache::remember('kave_balance', 100, function () {
//                $response = Http::withOptions(['timeout' => 5])->get('https://api.kavenegar.com/v1/' .env('KAVENEGAR_API_KEY') . '/account/info.json');
//                if ($response->ok()) {
//                    return $response->json()['entries']['remaincredit'] / 10;
//                } else {
//                    return 0;
//                }
//            });
//        } catch (Exeption $e) {
//            event(new ActivityEvent($e->getMessage(), 'Kavenegar', false));
//            $this->kavehnegarBalance=0;
//        }
    ...
    {
        $this->authorize('home_index', HomeIndex::class);
