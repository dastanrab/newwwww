...
{{--                            @endphp--}}
                          @php
                              $warehouse_1_weight=$user->warehouseDailies->whereIn('operator_id', User::azadiId())->pluck('weight')->sum();
                          @endphp
                            <td id="w1-{{$row}}"
...
{{--                            @endphp--}}
                            @php
                                $warehouse_2_weight=$user->warehouseDailies->whereIn('operator_id', User::mayameyId())->pluck('weight')->sum();
                            @endphp
                            <td id="w2-{{$row}}"
