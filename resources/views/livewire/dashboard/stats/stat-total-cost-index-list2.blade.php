        ...
        <div class="table-responsive  text-center text-nowrap tableFixHead">
            ...
            <table class="cr-table table" >
                ...
                <tr>
                    ...
                    <th>موجودی کیف پول کاربران آنیروب  (تومان)</th>
                    <th>موجودی کیف پول کاربران آنیروب + در انتظار پرداخت ها (تومان)</th>
                    <th> مجموع پسماند تحویلی از کاربر (تومان)</th>
                    <th> مجموع واریز کیف پول آنیروب (تومان)</th>
                    <th> مجموع برداشت کیف پول آنیروب (تومان)</th>
                    <th>بالانس</th>
                    <th>واریز پسماند تلفنی کیف پول آنیروب (تومان)</th>
                    <th> واریز پسماند اپ پول آنیروب (تومان)</th>
                    <th>واریز پول برگشتی کیف پول آنیروب (تومان)</th>
                    <th>واریز پاداش اولین درخواست کیف پول آنیروب (تومان)</th>
                    <th>واریز دستی ادمین کیف پول آنیروب (تومان)</th>
                    <th>واریز پاداش معرف کیف پول آنیروب (تومان)</th>
                    <th>واریز دزخواست ثبت نشده کیف پول آنیروب (تومان)</th>
                    <th>واریز اینترنت برگشتی کیف پول آنیروب (تومان)</th>
                    <th>واریز موبایل برگشتی کیف پول آنیروب (تومان)</th>
                    <th>برداشت مستقیم تحویل پسماند کیف پول آنیروب (تومان)</th>
                    <th>برداشت غیر مستقیم کاربر کیف پول آنیروب (تومان)</th>
                    <th>برداشت غیر مستقیم کاربر(توسط ادمین) کیف پول آنیروب (تومان)</th>
                    <th>برداشت برای آپ از کیف پول آنیروب (تومان)</th>
                    <th>برداشت شارژ اینترنت از کیف پول آنیروب (تومان)</th>
                    <th>برداشت شارژ مکالمه از کیف پول آنیروب (تومان)</th>
                    <th>برداشت اختلاف (ادمین)از کیف پول آنیروب (تومان)</th>
