...
{{--                                            <p>بازیست در راستای ایجاد محیط زیست پایدار و به عنوان راهکاری اثربخش برای آسایش شهروندان گرامی اقدام به ایجاد سیستم موثر و کارآمد در جهت جمع‌آوری و بازیافت پسماند خشک نموده است.</p>--}}
{{--                                        </div>--}}
{{--                                        <div class="carousel-item">--}}
{{--                                            <h1>کمک به محیط زیست پایدار شهری</h1>--}}
{{--                                            <p>مجموعه بازیست در راستای حفظ و حمایت از محیط‌زیست و تضمین بهره‌مندی صحیح و مستمر از آن، اقدام به راه‌اندازی سیستمی هوشمند در جهت بالا بردن سطح کیفی و ارتقای فرهنگ تفکیک زباله و جمع‌آوری و بازیافت پسماند خشک نموده است.--}}
{{--                                            </p>--}}
{{--                                        </div>--}}
{{--                                        <div class="carousel-item">--}}
                ...
                <div class="col-lg-6 col-12 p-0">
                    <div class="cr-form animate__animated animate__fadeIn">
                        ...
                        <div class="cr-content">
                            <div class="cr-title">
                                <strong>ناحیه کاربری</strong>
                                <p>با ورود و یا ثبت نام در بازیست شما شرایط و قوانین و حریم خصوصی
                                    <br>
                                    استفاده از سرویس های سایت بازیست را می‌پذیرید.
                                </p>
                            </div>
                                    ...
                                    @if($type == 'mobile')
                                        ...
                                        <div class="col-12">
                                            <div class="cr-text cr-icon cr-md mb-3">
                                                ...
                                                <input wire:model="password" type="password" id="Password" placeholder="رمز عبور خود را وارد کنید">
                                            </div>
                                        </div>
                                    @elseif($type == 'code')
                                        <div class="col-12">
